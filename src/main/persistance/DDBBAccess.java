...
import main.persistance.exceptions.MaxConnectionsReachedException;
...
public class DDBBAccess {
    ...
    public int executeUpdate(String sql, Object @NotNull ... params) throws SQLException, MaxConnectionsReachedException {
        int connectionId = this.getAvailableConnectionHandler();
        int i = 0;
